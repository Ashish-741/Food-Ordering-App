...
/**
 * Global exception handler — catches all exceptions and returns consistent ApiResponse format.
 * This ensures the frontend always gets a predictable JSON structure.
 */
